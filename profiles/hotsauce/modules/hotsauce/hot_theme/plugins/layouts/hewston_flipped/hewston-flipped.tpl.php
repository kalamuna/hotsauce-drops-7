...
<div class="panel-display hewston-flipped clearfix container <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>

  <div class="hewston-flipped-container hewston-flipped-top clearfix row-fluid">
    <div class="hewston-flipped-top-region hewston-flipped-slider-gutter panel-panel span4">
    ...
    <div class="hewston-flipped-top-region hewston-flipped-slider panel-panel span8">
