...
<div class="panel-display brown clearfix container <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>

  <div class="brown-container brown-top clearfix row-fluid">
    <div class="brown-top-region brown-slider panel-panel span8">
      <div class="brown-top-region-inner brown-slider-inner panel-panel-inner">
        <?php print $content['slider']; ?>
      </div>
    </div>
    <div class="brown-top-region brown-slider-gutter panel-panel span4">
